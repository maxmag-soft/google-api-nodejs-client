...
export namespace cloudfunctions_v2beta {
  ...
  export class Resource$Projects$Locations$Functions {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+parent}/functions').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    generateDownloadUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:generateDownloadUrl').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    generateUploadUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v2beta/{+parent}/functions:generateUploadUrl'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
    ...
    getIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+resource}:getIamPolicy').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    setIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+resource}:setIamPolicy').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    testIamPermissions(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+resource}:testIamPermissions').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Runtimes {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+parent}/runtimes').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
