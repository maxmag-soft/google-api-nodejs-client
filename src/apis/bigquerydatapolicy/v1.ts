...
export namespace bigquerydatapolicy_v1 {
   ...
   * ```
   */
  export class Bigquerydatapolicy {
  ...
  export interface Schema$DataMaskingPolicy {
     ...
     */
    predefinedExpression?: string | null;
    /**
  ...
  export interface Schema$DataPolicy {
     ...
     */
    dataMaskingPolicy?: Schema$DataMaskingPolicy;
    /**
   ...
   */
  export interface Schema$ListDataPoliciesResponse {
    /**
     * Data policies that belong to the requested project.
     */
    dataPolicies?: Schema$DataPolicy[];
    /**
   ...
   */
  export interface Schema$RenameDataPolicyRequest {
    /**
  ...
  export class Resource$Projects$Locations {
    context: APIRequestContext;
    dataPolicies: Resource$Projects$Locations$Datapolicies;
    constructor(context: APIRequestContext) {
      this.context = context;
      this.dataPolicies = new Resource$Projects$Locations$Datapolicies(
        this.context
      );
    }
  }

  export class Resource$Projects$Locations$Datapolicies {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
    ...
    create(
      params: Params$Resource$Projects$Locations$Datapolicies$Create,
      options: MethodOptions | BodyResponseCallback<Schema$DataPolicy>,
      callback: BodyResponseCallback<Schema$DataPolicy>
    ): void;
    create(
      params: Params$Resource$Projects$Locations$Datapolicies$Create,
      callback: BodyResponseCallback<Schema$DataPolicy>
    ): void;
    create(callback: BodyResponseCallback<Schema$DataPolicy>): void;
    create(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Create
      ...
      if (typeof paramsOrCallback === 'function') {
        ...
        params = {} as Params$Resource$Projects$Locations$Datapolicies$Create;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/dataPolicies').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$DataPolicy>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$DataPolicy>(parameters);
      }
    }
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Delete
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Datapolicies$Delete;
        options = {};
      }
    ...
    get(callback: BodyResponseCallback<Schema$DataPolicy>): void;
    get(
      paramsOrCallback?:
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Datapolicies$Get;
        options = {};
      }
    ...
    getIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Getiampolicy
    ...
    list(callback: BodyResponseCallback<Schema$ListDataPoliciesResponse>): void;
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$List
        | BodyResponseCallback<Schema$ListDataPoliciesResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Datapolicies$List;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$ListDataPoliciesResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListDataPoliciesResponse>(parameters);
      }
    }
    ...
    patch(callback: BodyResponseCallback<Schema$DataPolicy>): void;
    patch(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Patch
        | BodyResponseCallback<Schema$DataPolicy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Datapolicies$Patch;
        options = {};
      }
    ...
    rename(callback: BodyResponseCallback<Schema$DataPolicy>): void;
    rename(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Rename
        | BodyResponseCallback<Schema$DataPolicy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Datapolicies$Rename;
        options = {};
      }
    ...
    setIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Setiampolicy
        | BodyResponseCallback<Schema$Policy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
    ...
    testIamPermissions(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Testiampermissions
        | BodyResponseCallback<Schema$TestIamPermissionsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
